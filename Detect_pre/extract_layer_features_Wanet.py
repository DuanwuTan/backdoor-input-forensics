...
def main():
    ...
    # 模型路径（请确认这是你训练好的后门模型）
    model_path = "./record/20260221_013811_wanet_attack_wanet_CF3H/attack_result.pt"
    ...
    for layer in layers:
        ...
        # 保存特征文件
        np.save(f'features_wanet_clean_{layer}.npy', clean_feats)
        np.save(f'features_wanet_poison_{layer}.npy', poison_feats)
