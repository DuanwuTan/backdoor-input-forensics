...
# 创建输出文件夹
os.makedirs('figures/0223/wanet_channels', exist_ok=True)
...
for layer in layers:
    ...
    plt.title(f'wanet {layer} Top {top_k} Important Channels')
    plt.legend()
    plt.savefig(f'figures/0223/wanet_channels/{layer}_channels.png', dpi=150)
    plt.close()
